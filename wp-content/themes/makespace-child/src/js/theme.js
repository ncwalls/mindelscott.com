(function($){
	...
	var jobsPage = function(){
		...
		jobList.find('li').each(function(i,el){
			if(i % 2 == 0){
				$(el).addClass('bg');
			}
		});
		...
		jobFilterLink.on('click', function(e){
			...
			jobList.find('li').removeClass('bg');

			if(target === 'all'){
				jobList.find('li').addClass('vis').each(function(i,el){
					if(i % 2 == 0){
						$(el).addClass('bg');
					}
				});
				...
				jobList.find('li').not(targetClass).removeClass('vis');
				jobList.find(targetClass).addClass('vis').each(function(i,el){
					if(i % 2 == 0){
						$(el).addClass('bg');
					}
				});
		...
		$('[data-action="application-form"]').on('click', function(e){
			e.preventDefault();
			var posTitle = $(this).attr('data-position');
			$('#input_2_4').val(posTitle);
			$('#application-job-title').html(posTitle);
