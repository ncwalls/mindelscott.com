...
!function(t){var n=function(){t('[data-action="job-filter"]').on("click",function(n){n.preventDefault(),t(this).attr("data-target")}),t('[data-action="job-toggle"]').on("click",function(){t(this).parents(".inner").toggleClass("expand")})};t(document).ready(function(){n()})}(jQuery);